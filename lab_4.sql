...
-- 6. Write a function to print numbers from 1 to N (Using while loop).

CREATE OR ALTER FUNCTION FN_1TON(@N INT)
    RETURNS VARCHAR(8000)
AS
BEGIN
    DECLARE @C INT, @Result VARCHAR(8000);
    SET @C = 1;
    SET @Result = '';
...
-- 12. Write a function which accepts two parameters: start date & end date, and returns the difference in days.
...
-- 13. Write a function which accepts year & month as parameters and returns the total days in the month.
...
-- 14. Write a function which accepts departmentID as a parameter and returns the details of persons.
